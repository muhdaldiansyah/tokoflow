    ...
    <>
      ...
      <section className="py-12 lg:py-16">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="mt-2 text-sm text-[#475569]">
            The free tier includes your first 50 orders. Top-ups and subscriptions are billed in Malaysian Ringgit via Billplz. Top-up credits never expire. Subscription plans auto-renew monthly unless cancelled before the renewal date. All prices exclude SST where applicable.
          </p>
          ...
          <h2 className="mt-8 text-lg font-semibold text-[#1E293B]">5. Directory listing</h2>
          <p className="mt-2 text-sm text-[#475569]">
            When your merchant profile has <em>List on directory</em> enabled (default ON), Tokoflow may display your public shop information at <code>tokoflow.com/store</code> and <code>tokoflow.com/store/[city]</code>. Public information includes business name, business description, city, business category, logo, and listed products with prices. Your direct link <code>tokoflow.com/[slug]</code> always works regardless of directory listing status. You can toggle the directory listing off at any time in <em>Settings</em>. <strong>Direct customer orders remain at 0% commission and you retain full ownership of the customer relationship.</strong> Any future marketplace-driven discovery features that introduce a platform commission will be opt-in and clearly disclosed before activation.
          </p>

          <h2 className="mt-8 text-lg font-semibold text-[#1E293B]">6. Tax compliance</h2>
          <p className="mt-2 text-sm text-[#475569]">
          ...
          <h2 className="mt-8 text-lg font-semibold text-[#1E293B]">7. Acceptable use</h2>
          <p className="mt-2 text-sm text-[#475569]">
          ...
          <h2 className="mt-8 text-lg font-semibold text-[#1E293B]">8. Limitation of liability</h2>
          <p className="mt-2 text-sm text-[#475569]">
          ...
          <h2 className="mt-8 text-lg font-semibold text-[#1E293B]">9. Termination</h2>
          <p className="mt-2 text-sm text-[#475569]">
          ...
          <h2 className="mt-8 text-lg font-semibold text-[#1E293B]">10. Governing law</h2>
          <p className="mt-2 text-sm text-[#475569]">
            These Terms are governed by the laws of Malaysia. Disputes are resolved in the courts of Kuala Lumpur.
          </p>

          <h2 className="mt-8 text-lg font-semibold text-[#1E293B]">11. Contact</h2>
          <p className="mt-2 text-sm text-[#475569]">
