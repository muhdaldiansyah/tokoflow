      ...
      <div className="w-full max-w-lg">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2.5 p-3 rounded-xl border text-left transition-all ${
                      selectedCategory === cat.id
                        ? "border-warm-green bg-warm-green/5 ring-2 ring-warm-green/20"
                        : "border-border bg-card hover:border-warm-green/30 hover:bg-card/80"
          ...
          <div className="space-y-6">
              ...
              {products.map((product, i) => (
                <div key={i} className="flex gap-2 items-center">
                  <input
                    ...
                    className="flex-1 h-12 px-4 bg-card border border-border rounded-xl shadow-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-warm-green/20 focus:border-warm-green"
                  />
                  <div className="relative w-32">
                    ...
                    <input
                      ...
                      className="w-full h-12 pl-10 pr-3 bg-card border border-border rounded-xl shadow-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-warm-green/20 focus:border-warm-green"
                    />
                  </div>
                  {products.length > 1 && (
                    <button
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={isLoading}
                className="flex-1 h-12 rounded-xl bg-warm-green text-white font-medium hover:bg-warm-green/90 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {isLoading ? (
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-12 px-4 bg-card border border-border rounded-xl shadow-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-warm-green/20 focus:border-warm-green"
                maxLength={60}
                autoFocus
              />
            ...
            <button
              ...
              className="w-full h-12 rounded-xl bg-warm-green text-white font-medium hover:bg-warm-green/90 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {isLoading ? (
                <Loader2 className="h-4 w-4 animate-spin" />
              ) : (
        ...
        {step === 3 && slug && (
          <div className="space-y-6">
            ...
            <button
              onClick={handleDone}
              className="w-full h-12 rounded-xl bg-warm-green text-white font-medium hover:bg-warm-green/90 transition-colors"
            >
              Go to dashboard
            </button>
