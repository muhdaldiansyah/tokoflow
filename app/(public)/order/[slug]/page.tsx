    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background px-4 py-16">
        <div className="max-w-md w-full text-center space-y-6">
          <div className="w-20 h-20 rounded-full bg-warm-green/10 flex items-center justify-center mx-auto">
  ...
  return (
    <>
      ...
      <PublicOrderForm
        ...
        hasBillplz={business.hasBillplz}
        ...
        deliveryRates={business.deliveryRates}
        isProActive={business.isProActive}
      />
    </>
  );
}
