...
export function MonthlyReport({ month, year, exportTrigger, onExportingChange, onHasDataChange, showAI, onCloseAI, initialBusinessName }: MonthlyReportProps) {
  ...
  const [businessName, setBusinessName] = useState(initialBusinessName || "My Store");
