...
export function PrepPageClient({ initialProduction, initialDateStr, businessName }: PrepPageClientProps) {
  const initialDate = (() => {
  ...
  const [hasData, setHasData] = useState(!!initialProduction && initialProduction.totalOrders > 0);
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-3">
      ...
      <ProductionList
        ...
        initialProduction={getDateString(selectedDate) === initialDateStr ? initialProduction : undefined}
