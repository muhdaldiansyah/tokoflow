...
// Day-1 nav: all core surfaces visible from the start. Only Tax hides behind
// the Pro gate (paid feature, not a volume gate). /today is the daily landing;
// /orders is the full ledger. Invoices is free for all (migration 051).
