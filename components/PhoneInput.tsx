...
/**
 * Phone input with 🇮🇩 +62 prefix (Tokoflow = Indonesia deployment).
 * User types: 812 3456 7890 (without 0 or 62)
 * Stored as: 62812345678901 (via normalizePhoneForStorage)
 *
...
// Strip prefix for display: "0812345678" → "812345678", "62812345678" → "812345678"
...
/**
 * Validate an Indonesian mobile phone. Returns an error message or null.
 * Indonesian mobile numbers start with 8 (after the 0 / +62 prefix); the local
 * portion is 9–12 digits (e.g. 0812-3456-7890).
 */
export function validatePhone(value: string): string | null {
  ...
  if (!num.startsWith("8")) return "Number must start with 8 (e.g. 0812, 0813, 0856)";
  if (num.length < 9) return "Number is too short";
  if (num.length > 12) return "Number is too long";
  return null;
}

/** Normalize for storage: always returns "62xxx" (e.g. 62812345678901). */
