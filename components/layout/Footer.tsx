...
const productLinks = [
  ...
  { title: "Browse stores", href: "/store" },
...
const companyLinks = [
  ...
  // Partner program hidden while the referral program is paused (REFERRAL_ENABLED).
  ...(REFERRAL_ENABLED ? [{ title: "Partner program", href: "/mitra" }] : []),
];
