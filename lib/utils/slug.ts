...
const RESERVED_SLUGS = new Set([
  ...
  // Directory — "store" is the live English path, "toko" + "stores" are kept
  // reserved so future renames or stored business slugs that happen to match
  // one of these labels don't collide with the directory routes.
  "store", "stores", "toko", "cari", "direktori",
]);
